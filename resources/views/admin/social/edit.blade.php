			  				...
			  				<form action="{{route('social.link.update',$data->id)}}" method="post" enctype="multipart/form-data">
			  					...
			  					<div class="row">
                                        ...
                                        @error('name')
										   ...
										   <div class="form-group">
											...
											<div class="input-group">
												<img src="{{URL::to($data->icon)}}" alt="" id="image" style="width: 40px;height: 40px;">
			  						...
			  						<div class="col-md-6">
                                        <div class="form-group">
                                            <label>Link</label>
                                            <input type="text" name="link" id="link" class="form-control @error('link') is-invalid @enderror" value="{{$data->link}}" required>
                                        </div>
                                        @error('link')
                                               <div class="alert alert-danger">{{ $message }}</div>
                                           @enderror
