		...
		<div class="container-fluid">
			<div class="card">
				<div class="card-header">
					...
					<a href="{{ route('education.create') }}" class="btn btn-sm btn-success float-right">
						...
						<table id="example1" class="table table-bordered table-striped table-hover">
							...
							<tbody>
								@foreach($data as $key => $row)
									<tr>
										<td>{{ $key + 1 }}</td>
										<td><strong>{{ $row->degree }}</strong></td>
										...
										<td>
											<div class="btn-group btn-group-sm" role="group">
												<a href="{{ route('education.edit', $row->id) }}" class="btn btn-info" title="Edit"><i class="fas fa-edit"></i></a>
												<a href="{{ route('education.delete', $row->id) }}" class="btn btn-danger" title="Delete" onclick="return confirm('Are you sure you want to delete this education?');"><i class="fas fa-trash"></i></a>
											</div>
										</td>
									</tr>
								@endforeach
