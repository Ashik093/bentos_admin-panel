						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="client_name" id="client_name" class="form-control @error('client_name') is-invalid @enderror" value="{{ old('client_name', $data->client_name) }}" required>
									@error('client_name')
								...
								<div class="form-group">
									...
									<input type="text" name="client_position" id="client_position" class="form-control @error('client_position') is-invalid @enderror" value="{{ old('client_position', $data->client_position) }}" placeholder="e.g., CEO at ABC Company">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="mb-2">
										@if($data->photo)
											<img id="photoPreview" src="{{ asset($data->photo) }}" alt="testimonial" style="max-width:150px; max-height:150px; display:block; border-radius:4px;" />
										@else
							...
							<div class="col-12">
								<div class="form-group">
									...
									<textarea name="message" id="message" class="form-control @error('message') is-invalid @enderror" rows="6" placeholder="Write the testimonial message..." required>{{ old('message', $data->message) }}</textarea>
									@error('message')
										<div class="invalid-feedback d-block">{{ $message }}</div>
									@enderror
								</div>
							...
							<div class="col-12">
								<button type="submit" class="btn btn-info"><i class="fas fa-save"></i> Update Testimonial</button>
